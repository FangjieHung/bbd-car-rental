...
describe('CommissionStore 沒有報價快照的訂單（前批驗收：看起來像「退佣是 0」）', () => {
  const unquoted: RentalOrder = { ...orderInMonth, id: 'b-old', priceBreakdown: undefined };

  function storeWith(rule: Partner['commission']) {
    TestBed.resetTestingModule();
    TestBed.configureTestingModule({
      providers: [
        { provide: ORDER_REPO, useValue: createInMemoryRepo<RentalOrder>([orderInMonth, unquoted]) },
