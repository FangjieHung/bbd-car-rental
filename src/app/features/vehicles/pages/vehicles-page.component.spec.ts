    ...
    TestBed.configureTestingModule({
      providers: [
        { provide: VEHICLE_REPO, useValue: createInMemoryRepo<Vehicle>([
          makeVehicle({ id: 'v1', plateNumber: 'ABC-123', model: 'Gogoro', type: 'scooter', status: 'available' }),
          makeVehicle({ id: 'v2', plateNumber: 'XYZ-999', model: 'Toyota Altis', type: 'car', status: 'rented' }),
          makeVehicle({ id: 'v3', plateNumber: 'DEF-456', model: 'Gogoro 2', type: 'scooter', status: 'maintenance' }),
        ]) },
